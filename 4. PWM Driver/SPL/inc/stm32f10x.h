...
/** 
  * @brief Serial1 Peripheral Interface
  */
...
#define STM32_SPI1                ((SPI_TypeDef *) SPI1_BASE)
...
#define AFIO_MAPR_SWJ_CFG                    ((uint32_t)0x07000000)        /*!< SWJ_CFG[2:0] bits (Serial1 Wire JTAG configuration) */
